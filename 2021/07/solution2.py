...
def least_fuel(input, point):
    ...
    for num in input:
        fuel_cost = 1 #reset fuel cost back to 1
        while num < point:
            fuel_used += fuel_cost #increase fuel used by the cost of the move
            num += 1 
            fuel_cost += 1 #increase the cost of the move
        while num > point:
            fuel_used += fuel_cost #increas fuel used by the cost of the move
            num -= 1
            fuel_cost += 1 #increase the cost of the move
